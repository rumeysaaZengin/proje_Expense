...
// // !izlediğimiz olaylar
// addBtn.addEventListener("click", addExpense);
// listArea.addEventListener("click",handeUpdate);
// userInput.addEventListener('input', saveUser);
// document.addEventListener('DOMContentLoaded', getUser);
// select.addEventListener('change', handleFilter);
...
//   // 1- inputlatrın değeri boş ise: alert ver ve fonksiyonu durdur
//   if (!nameInput.value || !priceInput.value) {
//     alert('Lütfen formu doldurunuz..');
//     return;
//   }
...
// function handeUpdate(event){
//   // tıklanılan elemana erişme
//   const ele =event.target;
//   // silme resminin kapasayıcısına eişme
//   const parent = ele.parentElement.parentElement;

//   // yalnızca silme işleminde çalışacak kod
//   if (ele.id === 'delete'){
//     // elementi silme
//     parent.remove();
